...
class Management:
    ...
    def AddStudent(self):
        ...
        self.course = Label(self.frame_1, text="Programme", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=100)
        self.course_entry = Entry(self.frame_1, bg=self.color_4, fg=self.color_3)
        self.course_entry.place(x=40,y=130, width=200)

        self.subject = Label(self.frame_1, text="Brach", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=100)
        ...
        self.birth = Label(self.frame_1, text="Date of Birth", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=240)
    ...
    def GetUpdateDetails(self, row):
        ...
        self.subject = Label(self.frame_1, text="Branch", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=100)
        self.subject_entry = Entry(self.frame_1, bg=self.color_4, fg=self.color_3)
    ...
    def ShowDetails(self, row):
        ...
        course = Label(self.frame_1, text="Programme", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=40,y=100)
        course_data = Label(self.frame_1, text=row[2], font=(self.font_1, 10)).place(x=40, y=130)

        subject = Label(self.frame_1, text="Branch", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=100)
        ...
        birth = Label(self.frame_1, text="Date of Birth", font=(self.font_2, 15, "bold"), bg=self.color_1).place(x=300,y=240)
    ...
    def Submit(self):
         ...
         if not self.is_valid_contact(contact):
            ...
            return
         try:
            connection = pymysql.connect(host='localhost', user='root', password='8098561570', database='student_management')
            curs = connection.cursor()
            ...
            row = curs.fetchone()
            if row is not None:
                messagebox.showerror("Error!", "The contact number already exists, please try again with another number", parent=self.window)
            else:
